package com.javarush.task16.task1602;
...
public class Solution {
    ...
    static void fixDate(List<Date> brokenDates) {
        for (Date broken : brokenDates) {
            if (broken.after(new Date())) {
                broken.setYear(broken.getYear() - 1900);
                broken.setMonth(broken.getMonth()-1);
            }
        }
    }
}